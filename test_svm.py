...
configFileClassifier = "configurations\\Configurations_Classifier-svm.xml"


classifier = Classifier(configFileClassifier, [],  trainFeaturesExtractor.features, trainFeaturesExtractor.labels, testFeaturesExtractor.features, testFeaturesExtractor.labels)
classifier.Train()
