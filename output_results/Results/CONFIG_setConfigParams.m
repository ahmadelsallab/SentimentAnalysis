...
function [CONFIG_strParams] = CONFIG_setConfigParams()
    ...
    CONFIG_strParams.sDefaultClassifierPath = '..\..\..\Generic Classifier\Generic_Classifier_0.15';
	...
	CONFIG_strParams.sConfigEnvPath = '..\..\Diactrization\Results\Configuration_0.158';
    ...
    CONFIG_strParams.eFeaturesMode = 'Raw';
    ...
    % BREADTH
    % NONE
    CONFIG_strParams.eMappingDirection = 'BREADTH';
...
%     CONFIG_strParams.bBreadthMapping = 1;
    ...
    CONFIG_strParams.vInitialLayersWidths = [60 60 60];
    ...
    CONFIG_strParams.nFinalFirstLayerWidth = 60;
    
    % In case of depth, this is the final depth required.
    CONFIG_strParams.nFinalNumLayers = 6;
    ...
    CONFIG_strParams.nBPNumEpochsBeforeMapping = 100;
    ...
    CONFIG_strParams.bEnablePretraining = 0;
        if (CONFIG_strParams.bEnablePretraining == 1) 
            ...
            CONFIG_strParams.nPreTrainEpochs = 100;
        else
    ...
    CONFIG_strParams.bBPEnablePenaltyIter = 1;
        ...
        CONFIG_strParams.nSquareBarrierMinimizerAlpha = 100; % Square barrier parameter
    ...
    CONFIG_strParams.eMappingMode = 'NN_BREADTH_CLASSIFIER_MAPPING'; % NN_CLASSIFIER_MAPPING, WEAK_CLASSIFIER_MAPPING, SEMI_RANDOM_CLASSIFIER_MAPPING, FULL_RANDOM_CLASSIFIER_MAPPING, SVM_TOP_LEVEL_INTEGRATED_CLASSIFIER_MAPPING
